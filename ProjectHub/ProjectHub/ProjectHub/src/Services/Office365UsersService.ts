...
export class Office365UsersService {
  ...
  public static async UpdateMyProfile(body?: GraphUserUpdateable_V1): Promise<IOperationResult<void>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ body?: GraphUserUpdateable_V1 }, void>({
      connectorOperation: {
  ...
  public static async MyProfile_V2($select?: string): Promise<IOperationResult<GraphUser_V1>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ $select?: string }, GraphUser_V1>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async UpdateMyPhoto(body: string, Content_Type: string): Promise<IOperationResult<void>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ body: string, Content_Type: string }, void>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async MyTrendingDocuments($filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string): Promise<IOperationResult<{ value: GraphTrending[] }>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string }, { value: GraphTrending[] }>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async RelevantPeople(userId: string): Promise<IOperationResult<LinklessEntityListResponse_List_Person>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ userId: string }, LinklessEntityListResponse_List_Person>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async MyProfile(): Promise<IOperationResult<User>> {
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<void, User>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async UserProfile(userId: string): Promise<IOperationResult<User>> {
    const parameters: { userId: string } = { userId };
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ userId: string }, User>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async UserPhotoMetadata(userId: string): Promise<IOperationResult<ClientPhotoMetadata>> {
    const parameters: { userId: string } = { userId };
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ userId: string }, ClientPhotoMetadata>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async UserPhoto(userId: string): Promise<IOperationResult<string>> {
    const parameters: { userId: string } = { userId };
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ userId: string }, string>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async SearchUser(searchTerm?: string, top?: number): Promise<IOperationResult<User[]>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ searchTerm?: string, top?: number }, User[]>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async SearchUserV2(searchTerm?: string, top?: number, isSearchTermRequired?: boolean, skipToken?: string): Promise<IOperationResult<EntityListResponse_IReadOnlyList_User>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ searchTerm?: string, top?: number, isSearchTermRequired?: boolean, skipToken?: string }, EntityListResponse_IReadOnlyList_User>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async TestConnection(): Promise<IOperationResult<void>> {
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<void, void>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async UserProfile_V2(id: string, $select?: string): Promise<IOperationResult<GraphUser_V1>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ id: string, $select?: string }, GraphUser_V1>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async DirectReports_V2(id: string, $select?: string, $top?: number): Promise<IOperationResult<{ value: GraphUser_V1[] }>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ id: string, $select?: string, $top?: number }, { value: GraphUser_V1[] }>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async UserPhoto_V2(id: string): Promise<IOperationResult<string>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ id: string }, string>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async TrendingDocuments(id: string, $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string): Promise<IOperationResult<{ value: GraphTrending[] }>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ id: string, $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string }, { value: GraphTrending[] }>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
  ...
  public static async HttpRequest(Uri: string, Method: string, Body?: string, ContentType?: string, CustomHeader1?: string, CustomHeader2?: string, CustomHeader3?: string, CustomHeader4?: string, CustomHeader5?: string): Promise<IOperationResult<ObjectWithoutType>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo as unknown as DataSourcesInfo).Data.executeAsync<{ Uri: string, Method: string, Body?: string, ContentType?: string, CustomHeader1?: string, CustomHeader2?: string, CustomHeader3?: string, CustomHeader4?: string, CustomHeader5?: string }, ObjectWithoutType>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
